...
main (void)
{
 ...
 /* Read the input file */
  ...
  if ((strcmp (input_params.files.source_file, "source.mdl") == 0) &&
      ...
      (strcmp (network.species[input_params.abundances.initial_abundances[2].species_idx].name, "N") == 0) &&
      (input_params.abundances.initial_abundances[2].abundance == 2.14e-5) &&
      (strcmp (network.species[input_params.abundances.initial_abundances[3].species_idx].name, "O") == 0) &&
      ...
      (strcmp (network.species[input_params.output.output_species_idx[3]].name, "e(-)") == 0) &&
      (strcmp (network.species[input_params.output.output_species_idx[4]].name, "OH") == 0))
    {
